...
console.log(`MUZAMIL-XD ♻ Auto Bio Started`);
//============================ Env=======================================================
...
async (conn, mek, m, { from, contextInfo, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *MUZAMIL-XD-ENV* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *𝔼ℕ𝕍 𝕊𝔼𝕋𝕋𝕀ℕ𝔾𝕊 📡*
┃▸└───────────···๏
╰────────────────┈⊷
...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerName = 'Muzamil Official'; // Replace this with the owner's name
        const organization = 'MUZAMIL-XD CODERS'; // Optional: replace with the owner's organization
...
*|* 🔁 ᴛᴇꜱᴛɪɴɢ...
╰━━━━━━━━━━━━━━━━━━⊷
> ᴘᴏᴡᴇʀᴇᴅ ʙʏ мʋʓαмιℓ Ƶ Яʋвαв Ƨнɛικн` 
    }, { quoted: m });
  ...
  async (conn,mek, m, { from, body, isGroup, isAdmins, isBotAdmins, reply, sender }) => {
      try {
          ...
          if (containsBadWord & config.ANTI_BAD === 'true') {
            ...
            await conn.sendMessage(from, { text: "🚫 ⚠️BAD WORDS NOT ALLOWED⚠️IN THE RULES OF MUZAMIL AND RUBAB SHEIKH 🚫" }, { quoted: mek });
          }
      } catch (error) {
          console.error(error)
  ...
  cmd({
      ...
      try {
          ...
          if (containsLink && config.ANTI_LINK === 'true') {
              ...
              // Warn the user
              await conn.sendMessage(from, { text: `⚠️ Links are not allowed in this group.\n@${sender.split('@')[0]} has been removed. 🚫by Rubab Sheikh`, mentions: [sender] }, { quoted: mek });
